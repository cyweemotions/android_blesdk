...
public class GetDoNotDisturbTask extends OrderTask {
    private byte[] orderData;
    public GetDoNotDisturbTask(MokoOrderTaskCallback callback) {
    ...
    public void parseValue(byte[] value) {
        ...
        int switch1 = Integer.parseInt(Integer.toHexString(subArray[0]), 16); //全天开启
        int switch2 = Integer.parseInt(Integer.toHexString(subArray[1]), 16); //定时开启
        ...
        LogModule.i("开关1" + switch1);
        LogModule.i("开关2" + switch2);
