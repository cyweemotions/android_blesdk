...
public class StandardAlertTask extends OrderTask {
    private byte[] orderData;
    public StandardAlertTask(MokoOrderTaskCallback callback, int toggle) {
        super(OrderType.WRITE, OrderEnum.setStandardAlert, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
