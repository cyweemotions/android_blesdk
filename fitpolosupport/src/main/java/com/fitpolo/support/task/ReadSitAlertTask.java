 ...
 * @Author wenzheng.liu
 * @Description 读取久坐提醒
 * @ClassPath com.fitpolo.support.task.ReadSitAlertTask
 */
public class ReadSitAlertTask extends OrderTask {
    private static final int ORDERDATA_LENGTH = 2;

    private byte[] orderData;

    public ReadSitAlertTask(MokoOrderTaskCallback callback) {
        super(OrderType.WRITE, OrderEnum.READ_SIT_ALERT, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
